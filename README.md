  ...
  "response": [
    {
        ...
        "oem": "OEM",
        "device": "Device Name",
        "filename": "Celestial-1.0-<date>-<device codename>-v<celestialversion>.zip",
        ...
        "dt": "https://github.com/celestialrom/android_device_<oem>_<device_codename>", #(mandatory)
        "common-dt": "https://github.com/celestialrom/android_device_<orm>_<SOC>-common", #(mandatory)
        "kernel": "https://github.com/celestialrom/android_kernel_<oem>_<SOC>" #(mandatory)
    }
  ]
}
```
...
### 3.1 Initial support ###
After you contacted [Gabriel on Telegram](https://telegram.me/hxfuxyy), and have the approval, follow the below steps.
...
```
git clone git@github.com:crdroidandroid/android_vendor_CelestialOTA.git
```
2. Change to the directory where you cloned this repo (android_vendor_CelestialOTA) and fetch updates from repo.
```
cd android_vendor_CelestialOTA
git fetch --all
git pull
```
